...
const Certificates = () => {
  return (
    ...
    <div className='flex flex-wrap flex-col gap-5 sm:flex-row '>
          <div className="flex items-end justify-center shadow-md max-w-sm sm:w-2/5 md:2/5 aspect-[4/3] bg-[url('/public/assets/images/udacity.png')] bg-center bg-cover">
         ...
         <div className="flex items-end justify-center shadow-md  max-w-sm sm:w-2/5 md:2/5 aspect-[4/3] bg-cover bg-[url('/public/assets/images/aws.jpg')] bg-center ">
         ...
         <div className="flex items-end justify-center shadow-md  max-w-sm sm:w-2/5 md:2/5 aspect-[4/3] bg-no-repeat bg-[length:200px] bg-[url('/public/assets/images/coursera-logo-full-rgb.png')] bg-center">
         ...
         <div className="flex items-end justify-center shadow-md  max-w-sm sm:w-2/5 md:2/5 aspect-[4/3] bg-no-repeat bg-[length:200px] bg-[url('/public/assets/images/HackerRank.png')] bg-center">
