  ...
  return (
    <div  >
        ...
        <div className='border-b-10 border-black'>
                    ...
                    <div className="media-Handles col">
                        ...
                        <div className='flex mb-5'>
                           ...
                           <BsGithub className='text-4xl shadow-md text-white'/>
                            ...
                            <div className="bg-slate-900 h-20 w-20 rounded-md flex items-center justify-center">
            ...
            <div className='flex overflow-hidden h-80 w-100 border-8'>
                 <img className='object-contain' src="https://images.unsplash.com/photo-1507608616759-54f48f0af0ee?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTAwfHxhcHAlMjBiYWNrZ3JvdW5kc3xlbnwwfHwwfHw%3D&auto=format&fit=crop&w=500&q=60" alt="placeholder" />
            </div>            
        </div>
    </div>
  )
